...
export const projects: Array<ProjectModel> = [
    {
    linkUrl: "",
    githubUrl: "https://github.com/ikiwq/go-inflation",
    postImage: {
      name: "goinflation.png",
    },
    projectDescription: `This is a more advanced experiment with my Golang and microservice knowledge I gathered over the years. The aim of this project was to register thousands (if not milions) of products everyday and then calculate inflation changes over long periods of time.`,
    technologies: ["Go", "gRPC", "Kafka", "PostgreSQL", "MongoDB"],
    title: "Go Inflation",
    featured: true,
  },
  {
